...
class GoogleParserTests(GoogleQueryTests):
    ...
    def test3(self):
        q = GoogleQuery('ru', 'стол', region='Москва', page=0)
        self.assertEqual(q.get_url(), 'https://www.google.ru/search?q=%D1%81%D1%82%D0%BE%D0%BB&num=10&as_dt=e&near=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0')

    def test4(self):
        q = GoogleQuery('ru', 'стол', region='Москва', page=1)
        self.assertEqual(q.get_url(), 'https://www.google.ru/search?q=%D1%81%D1%82%D0%BE%D0%BB&num=10&as_dt=e&near=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0')

    def test5(self):
        q = GoogleQuery('ru', 'стол', region='Москва', page=2)
    ...
    def test6(self):
        q = GoogleQuery('ru', 'стол', region='Москва', page=2, num=50)
        self.assertEqual(q.get_url(), 'https://www.google.ru/search?q=%D1%81%D1%82%D0%BE%D0%BB&num=50&start=50&as_dt=e&near=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0')
    ...
    def test8(self):
        q = GoogleQuery('com', 'стол', region='Washington', page=2, num=50)
        self.assertEqual(q.get_url(), 'https://www.google.com/search?q=%D1%81%D1%82%D0%BE%D0%BB&num=50&start=50&hl=en&gl=US&gr=US-UT&gcs=NewYork&as_dt=e&near=Washington')

    def test9(self):
        q = GoogleQuery('info', 'стол', region='Washington', page=2, num=50)
        self.assertEqual(q.get_url(), 'https://www.google.info/search?q=%D1%81%D1%82%D0%BE%D0%BB&num=50&start=50&as_dt=e&near=Washington')
